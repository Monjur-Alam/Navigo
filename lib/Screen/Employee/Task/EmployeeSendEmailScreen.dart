...
class EmployeeSendEmailScreen extends StatefulWidget {
  ...
  EmployeeSendEmailScreen({Key key, this.id}) : super(key: key);

  @override
  _EmployeeSendEmailScreenState createState() => _EmployeeSendEmailScreenState();
}

class _EmployeeSendEmailScreenState extends State<EmployeeSendEmailScreen> {
